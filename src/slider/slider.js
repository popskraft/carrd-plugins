(function() {
  ...
  const ext = (typeof window !== 'undefined' && window.CarrdPluginOptions && window.CarrdPluginOptions.slider) || {};
  ...
  window.CarrdSlider = { init, destroyAll, destroyById, getInstances: () => SLIDER_INSTANCES.map(e => e.instance) };
